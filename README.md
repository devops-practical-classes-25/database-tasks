...
Вам необходимо заполнить базу данных тестовыми данными. Ниже представлено описание информации, которую нужно внести в таблицы.

В базе данных должны быть записаны три автора:

1. Лев Толстой, родился в 1828 году.

2. Фёдор Достоевский, родился в 1821 году.

3. Антон Чехов, родился в 1860 году.

Каждый автор написал хотя бы одну книгу:

+ Лев Толстой – автор книги "Война и мир", изданной в 1869 году.

+ Фёдор Достоевский – автор книги "Преступление и наказание", изданной в 1866 году.

+ Антон Чехов – автор книги "Чайка", изданной в 1896 году.

Также в базе есть три читателя, зарегистрированные с именами и адресами электронной почты:

1. Иван Иванов, email: ivanov@example.com.

2. Мария Смирнова, email: smirnova@example.com.

3. Алексей Петров, email: petrov@example.com.

Читатели брали книги в библиотеке. В записях выдачи указаны даты выдачи и возврата книг (если они были возвращены):

1. Иван Иванов взял книгу "Война и мир" 1 марта 2024 года и пока не вернул.

2. Мария Смирнова брала книгу "Преступление и наказание" 20 февраля 2024 года и вернула её 10 марта 2024 года.

3. Алексей Петров взял книгу "Чайка" 5 марта 2024 года и пока не вернул.

На основе этого описания вам необходимо создать и заполнить соответствующие таблицы в базе данных.
